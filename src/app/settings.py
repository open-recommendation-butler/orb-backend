...
CORS_ALLOWED_ORIGINS = ['http://localhost:3000', f'https://{env("DOMAIN", default="")}', f'https://open-recommendation-butler.tech', f'https://omr.open-recommendation-butler.tech']
